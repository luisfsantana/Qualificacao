...
\large Co-orientador: Dr. Daniel Cordeiro}}
...
\begin{doublespacing}
O uso de GPUs (Graphic Processor Unit) em aplicações científicas está cada vez mais difundido, com
...
utilização das GPUs e minimizar o tempo de execução da aplicação. Este
projeto tem como objetivo o desenvolvimento de um algoritmo de balanceamento de
cargas dinâmico para aglomerados de GPUs. Implementamos o algoritmo no \textit{framework} StarPu, um arcabouço para o desenvolvimento de aplicações para
aglomerados e comparamos seu desempenho com outros algoritmos de
